...
dat[SubPopNew ==1, c("AmpR", 'AzmR', "CipR", "CotR",  'AxoR') := 
      list(AMP_Concl=='R', 
           AZM_Concl=='R',
           CIP_Concl %in% c('I', 'R'),
           COT_Concl=='R', 
...
```{r}
dat$NonSevere<-ifelse(dat$Fever=='YES'|dat$HospClean==T|dat$BloodyDiarr=='YES'|dat$Bacteremia==T|dat$Death==T, F, T)
```
...
```{r}
options(scipen=500)
write.csv(dat, "//cdc.gov/project/ATS_GIS_Store4/Projects/prj06135_Shigella_SVI/Data/FoodNet_NARMS/analytic_file_V5.csv", row.names=F)
```
